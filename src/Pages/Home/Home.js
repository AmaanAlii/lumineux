      ...
      <div className="home-banner-section">
        ...
        <div className="home-banner-mid-content">
          <div className="home-banner-left-heading">
            ...
            <span>
              We boast a sterling reputation for surpassing our clients'
              expectations and delivering outstanding outcomes through our
              commitment, streamlined processes, and extraordinary services to
      ...
      <div className="home-main-content">
        <div className="home-about-section">
          ...
          <div className="home-about-left-info">
            <h3>ABOUT AGENCY</h3>
            <h3>
              ACHIEVE YOUR REAL ESTATE GOALS WITH <br />
              <span className="home-colored-text"> OUR AGENCY!</span>
            </h3>
            <div className="home-about-text-section">
              ...
              <div className="home-about-text">
                <span>
                  ...
                  buying, selling, and renting properties. We employ licensed
                  real estate agents who are experienced and knowledgeable about
                  the real estate market in the area. Additionally, in order to
                  ensure our clients achieve the best possible outcome for their
                  property-related transactions, we provide them with the
                  support and assistance they need to navigate the real estate
                  process. This includes helping them with assessing the value
                  of properties, understanding the local market and determining
                </span>
          ...
          <div className="home-about-right-image">
            <img src={HomeAboutImg2} alt="Home Right" />
          </div>
        </div>
